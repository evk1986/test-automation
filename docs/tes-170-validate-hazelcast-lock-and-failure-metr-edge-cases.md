# Edge Cases: Validate Hazelcast lock and failure metrics for Device-Probe (PRB-4821 QA)
...
## Validation
- Validate Hazelcast lock and failure metrics for Device-Probe (PRB-4821 QA)
